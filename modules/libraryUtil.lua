-- this is an internal mediawiki lua module, so you won't find it at
-- Module:libraryUtil or Module:LibraryUtil, but it's imported by some
-- modules like Arguments.lua as require('libraryUtil') (no "Module:").
-- i copied the lua code from the mediawiki source code to here
-- so that those modules that use this don't fail and we can produce their
-- output locally.
